...
function initializeApp() {
    document.addEventListener('DOMContentLoaded', () => {
        try {
            ...
            // Load and apply saved style settings (moved to showTab for tab-specific refresh)
            // loadStyleSettings(); // Removed from here
    ...
    // Enhance dataUpdated listener to force full UI refresh
